                                ...
                                @if ($order->order_attachment)
                                                ...
                                                <div>
                                                    <button class="btn w-100 px-0" data-toggle="modal"
                                                        ...
                                                        <div class="gallary-card ml-auto">
                                                            <img
                                                                src="{{ asset('storage/app/' . 'public/order/' . $item) }}"
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                ...
                                                                <button type="button" class="close"
                                                                        ...
                                                                        class="sr-only">{{ translate('messages.cancel') }}</span>
                                                                </button>
                                                            </div>
                                    ...
                                    @else
                                        ...
                                        <button class="btn w-100 px-0" data-toggle="modal" data-target="#imagemodal"
                                            ...
                                            <div class="gallary-card ml-auto">
                                                <img
                                                    src="{{ asset('storage/app/' . 'public/order/' . $order->order_attachment) }}"
                                                    alt="{{ translate('messages.prescription') }}"
                                                    class="initial--22 object-cover">
                                            </div>
                                        </button>
                            ...
                            <div class="col-md-9 col-lg-8">
                                <dl class="row text-right">
                                    ...
                                    <dd class="col-6">
                                        @if ($order->prescription_order == 1 && in_array($order['order_status'],['pending','confirmed','processing','accepted']))
                                            <button class="btn btn-sm" type="button" data-toggle="modal"
                                                    data-target="#edit-discount-amount"><i class="tio-edit"></i>
                                            </button>
                                        @endif
                                    ...
                                    <dt class="col-6">{{ \App\CentralLogics\Helpers::get_business_data('additional_charge_name')??translate('messages.additional_charge') }}
                                        :
                                    </dt>
                                    <dd class="col-6">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title h4"
                        id="mySmallModalLabel">{{ translate('messages.add_delivery_proof') }}</h5>
